...
export default function Services() {
  ...
  const serviceImages = [
    ...
    "https://images.unsplash.com/photo-1581094288338-2314dddb7ecc?auto=format&fit=crop&q=80&w=1200", // MEP
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
          ...
          <div className="lg:col-span-7 sticky top-32">
            <Link to={`/services#${SERVICES[activeService].id}`} className="block relative aspect-[4/5] md:aspect-video lg:aspect-[4/5] rounded-[4rem] overflow-hidden shadow-2xl border-[12px] border-white/5 group">
